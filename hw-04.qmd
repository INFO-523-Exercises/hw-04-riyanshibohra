...
X <- stocks$open         # dependant variable 
y <- stocks$adj_close     # independent variable
```
...
Process Overview: Data Splitting: Divide the dataset into training and test sets. \n Model Fitting: Fit the MLR model to the training data. Prediction: Apply the model to the test data to make predictions. Evaluation: Assess the model's performance using appropriate metrics. Postprocessing: Visualize the model's results for better understanding and interpretation.
